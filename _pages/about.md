...
I like solving machine learning puzzles, i.e., mysterious "Alchemical" phenomena with major impacts, such as, [overthinking in LLM reasoning](https://arxiv.org/abs/2502.07266), [why DINO features won't collapse](https://arxiv.org/pdf/2303.02387), [why MAE learns good features](https://proceedings.neurips.cc/paper_files/paper/2022/hash/adb2075b6dd31cb18dfa727240d2887e-Abstract-Conference.html), [why adversarial training easily overfits](https://arxiv.org/pdf/2310.19360.pdf), and [why robust models become generative](https://arxiv.org/abs/2203.13455). Let me know if you have one!

I occasionally post latest research highlights on [Twitter](https://x.com/yifeiwang77/highlights). 
